      ...
      >
        <div className="flex w-full items-center justify-between px-7 py-2 ">
          ...
          <div
            ...
            className="cursor-pointer borderGeradiant flex h-14 w-14 items-center justify-center rounded-full bg-white bg-opacity-50 backdrop-blur-sm"
          >
            <motion.svg
              initial={false}
